...
public class ModeloTest {
	...
	public void komprobatuStocka(){
		...
		String query1 = ("SELECT stock from vende where NIFLocal = (select NIF from operaciones where NumTrans = (SELECT max(NumTrans) from operaciones) and NomProducto = 'Ardoa'");
		...
		assertEquals(stockaKantitatea, metodoak.komprobatuStocka("Ardoa"));
